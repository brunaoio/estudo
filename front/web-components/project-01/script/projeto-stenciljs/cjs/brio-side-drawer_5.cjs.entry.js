...
const SideDrawer = class {
  ...
  render() {
    ...
    if (this.showContactInfo) {
      mainContent = (index.h("div", { id: "contact-information" }, index.h("h2", null, "Contact Information"), index.h("p", null, "You can reach us via phone or e-mail"), index.h("ul", null, index.h("li", null, "Phone: 55 21 974750921"), index.h("li", null, "E-mail: ", index.h("a", { href: "mailto:tocarj@gmail.com" }, "tocarj@gmail.com")))));
    }
    return ([index.h("div", { class: "backdrop", onClick: this.onCloseDrawer.bind(this) }),
      index.h("aside", null, index.h("header", null, index.h("h1", null, this.titulo), index.h("button", { onClick: this.onCloseDrawer.bind(this) }, "X")), index.h("section", { id: "tabs" }, index.h("button", { class: !this.showContactInfo ? 'active' : '', onClick: this.onChangeContent.bind(this, 'nav') }, "Navigation"), index.h("button", { class: this.showContactInfo ? 'active' : '', onClick: this.onChangeContent.bind(this, 'contact') }, "Contact")), index.h("main", null, mainContent))]);
    // let content = null;
    // if (this.open) {
    //     content = (
    //         <aside>
...
const Spinner = class {
  ...
  render() {
    return index.h("div", { class: "loadingio-spinner-spinner-wnqg7qibvjd" }, index.h("div", { class: "ldio-2u0v215ve73" }, index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null), index.h("div", null)));
  }
};
...
const StockFinder = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.brioStockSymbolClicked = index.createEvent(this, "brioStockSymbolClicked", 7);
    this.searchResults = [];
    this.loading = false;
  }
  ...
  render() {
    let content = index.h("ul", null, this.searchResults.map(el => {
      return index.h("li", { onClick: this.onStockSymbolClicked.bind(this, el.symbol) }, index.h("strong", null, el.symbol), " - ", el.name);
    }));
    if (this.loading) {
      content = index.h("brio-spinner", null);
    }
    return index.h(index.Host, null, index.h("form", { onSubmit: this.onFindStockSymbol.bind(this) }, index.h("input", { id: "stock-symbol", type: "text", ref: el => this.stockInput = el }), index.h("button", { type: "submit" }, "Find")), content);
  }
};
...
const StockPrice = class {
  ...
  render() {
    let dataContent = index.h("p", null, "Please insert a valid Stock Symbol");
    if (this.error) {
      dataContent = index.h("p", null, this.error);
    }
    else if (this.fetchedPrice) {
      dataContent = index.h("p", null, "Price: U$ ", this.fetchedPrice);
    }
    if (this.loading) {
      dataContent = index.h("brio-spinner", null);
    }
    return (index.h(index.Host, { class: this.error ? 'error' : '' }, index.h("form", { onSubmit: this.onFetchStockPrice.bind(this) }, index.h("input", { id: "stock-symbol", ref: el => this.stockInput = el, value: this.stockSymbolInputValue, onInput: this.onStockSymbolValueInput.bind(this) }), index.h("button", { type: "submit", disabled: !this.isStockSymbolValid }, "fetch")), index.h("div", null, dataContent)));
  }
...
const Tooltip = class {
  ...
  render() {
    return (index.h("host", null, index.h("slot", null), index.h("span", { id: "icon", onClick: this.toogle.bind(this) }, this.icon), index.h("div", { id: "texto-tooltip" }, this.texto)));
  }
};
Tooltip.style = tooltipCss;

exports.brio_side_drawer = SideDrawer;
exports.brio_spinner = Spinner;
exports.brio_stock_finder = StockFinder;
exports.brio_stock_price = StockPrice;
exports.brio_tooltip = Tooltip;
